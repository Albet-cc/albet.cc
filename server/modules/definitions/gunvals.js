...
// Snipers
    ...
    assassin: { reload: 1.65, shudder: 0.25, health: 1.15, damage: 2, pen: 0.7, speed: 1.18, maxSpeed: 1.18, density: 3, resist: 1.3 },
    hunter: { reload: 1.5, recoil: 0.7, size: 0.95, damage: 1.3, speed: 1.1, maxSpeed: 0.8, density: 1.2, resist: 1.15 },
    hunterSecondary: { size: 0.9, health: 2, damage: 0.8, pen: 1.5, density: 1.2, resist: 1.1 },
    predator: { reload: 1.4, size: 0.8, health: 1.5, damage: 1.2, pen: 1.5, speed: 0.9, maxSpeed: 0.9 },
...
// Machine guns
    ...
    minigun: { reload: 1.25, recoil: 0.6, size: 0.8, health: 0.55, damage: 0.86, pen: 1.05, speed: 1.33, density: 1.25, spray: 0.5, resist: 1.1 },
...
// Drones
    ...
    battleship: { health: 1.5, damage: 1, maxSpeed: 1.35, resist: 1.1 },
    carrier: { reload: 1.5, damage: 1.2, speed: 1.5, maxSpeed: 1.6, range: 1.2 },
...
// Missiles
    ...
    skimmer: { recoil: 0.8, shudder: 0.8, size: 0.9, health: 1.35, damage: 0.8, pen: 2, speed: 0.5, maxSpeed: 0.5, resist: 1.1 },
...
// Traps and blocks
    setTrap: { reload: 1.28, recoil: 1, shudder: 1, size: 1.5, health: 1.1, damage: 2, pen: 1.6, speed: 1.3, maxSpeed: 1.5, range: 1.25, resist: 1.25 },
