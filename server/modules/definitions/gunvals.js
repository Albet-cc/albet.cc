...
// Bases
    ...
    swarm: { reload: 23.5, recoil: 0.35, shudder: 0.05, size: 0.4, damage: 2.6, speed: 4, spray: 5 },
...
// Snipers
    ...
    hunter: { reload: 1.5, recoil: 0.7, size: 0.95, damage: 0.8, speed: 1.1, maxSpeed: 0.8, density: 1.2, resist: 1.15 },
    hunterSecondary: { size: 0.9, health: 1.15, damage: 0.45, pen: 1, density: 1.2, resist: 1.1 },
    predator: { reload: 1.4, size: 0.8, health: 1.3, damage: 0.9, pen: 1.1, speed: 0.9, maxSpeed: 0.9 },
...
// Drones
    ...
    summoner: { reload: 0.4, size: 1.125, health: 1.3, damage: 1, pen: 1.1, density: 0.8 },
    minionGun: { recoil: 0, shudder: 2, health: 0.4, damage: 0.4, pen: 1.2, range: 0.75, spray: 2 },
    babyfactory: { reload: 1.5, maxSpeed: 1.5 },
    bigCheese: { reload: 1.55, size: 1.8, health: 3.2, speed: 1.35, damage: 1.5 },
...
// Heavy cannons
    ...
    destroyer: { reload: 2, recoil: 1.75, shudder: 0.5, health: 1.65, damage: 1.35, pen: 1.2, speed: 0.65, maxSpeed: 0.3, density: 2, resist: 3 },
    annihilator: { reload: 1.15, recoil: 1.275 },
    hive: { reload: 1.5, recoil: 0.8, size: 0.8, health: 0.7, damage: 0.3, maxSpeed: 0.6 },
    artillery: { reload: 1.3, recoil: 0.7, size: 0.9, speed: 1, maxSpeed: 0.95, density: 1.5 },
    mortar: { reload: 1.2, health: 1.1, speed: 0.8, maxSpeed: 0.8 },
    shotgun: { reload: 8, recoil: 0.4, size: 1.5, damage: 0.36, pen: 0.8, speed: 1.8, maxSpeed: 0.6, density: 1.2, spray: 1.2 },
...
// Missiles
    ...
    snakeskin: { reload: 0.6, shudder: 2, health: 0.5, damage: 0.5, speed: 2, maxSpeed: 0.2, range: 0.4, spray: 5, recoil: 0.1 },
    sidewinder: { reload: 1.5, recoil: 0.9, health: 1.5, damage: 0.9, speed: 0.3, maxSpeed: 0.6 },
    rocketeer: { reload: 1.7, shudder: 0.9, size: 1.2, health: 1.25, damage: 1.6, pen: 1.5, speed: 0.4, range: 1.5, resist: 1.4 },
...
// Traps and blocks
    setTrap: { reload: 1.28, recoil: 1, shudder: 1, size: 1.5, health: 1, damage: 1.8, pen: 1.3, speed: 1.55, maxSpeed: 1.75, range: 1.2, resist: 1.25 },
    construct: { reload: 1.3, size: 0.9, maxSpeed: 1.4 },
