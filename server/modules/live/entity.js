...
class Entity extends EventEmitter {
    ...
    refreshBodyAttributes() {
        ...
        this.health.set(((this.settings.healthWithLevel ? funnycurve(this.level ** Config.LEVEL_EXPONENT_HEALTH, Config.LEVEL_SCALE_HEALTH, Config.LEVEL_EXPONENT_HEALTH / 5, Config.LEVEL_BASE_HEALTH, Config.LEVEL_SCALE_START) : 0) + this.HEALTH) * this.skill.hlt * healthMultiplier);
        ...
        this.density = densityMultiplier * funnycurve(this.level, Config.LEVEL_SCALE_DENSITY, ((this.level / 45) ** Config.LEVEL_EXPONENT_DENSITY), Config.LEVEL_BASE_DENSITY, Config.LEVEL_SCALE_START) * this.DENSITY;
    ...
    move() {
        ...
        switch (this.motionType) {
            ...
            case "motor":
                ...
                if (gactive) {
                    let len = this.scaledAcceleration / Math.sqrt(g.x ** 2 + g.y ** 2);
                    engine.x = g.x * len;
                    engine.y = g.y * len;
                }
                break;
