module.exports = {
    ...
    FOOD_SPAWN_COOLDOWN_NEST: 150, // Cooldown (in game ticks) of nest food spawn attempts being made.
    ...
    LEVEL_EXPONENT_HEALTH: 0.275,
 
    LEVEL_BASE_SHIELD: 0,
    LEVEL_SCALE_SHIELD: 0.6,
    LEVEL_EXPONENT_SHIELD: 1,

    LEVEL_BASE_REGEN: 1,
    LEVEL_SCALE_REGEN: 0.006,
    LEVEL_EXPONENT_REGEN: 1.01,

    LEVEL_BASE_DENSITY: 1,
    LEVEL_SCALE_DENSITY: 0.08,
    LEVEL_EXPONENT_DENSITY: 1,
